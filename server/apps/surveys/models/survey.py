...
class Survey(BaseModel):
    """Модель опроса"""
    company = models.ForeignKey(to='companies.Company', on_delete=models.CASCADE, related_name='surveys', verbose_name=_("Компания"))
    creator = models.ForeignKey(to='auth.User', on_delete=models.CASCADE, related_name='surveys', verbose_name=_("Создатель"))
    ...
    passing_score = models.PositiveIntegerField(default=0, verbose_name=_("Проходной балл"))
